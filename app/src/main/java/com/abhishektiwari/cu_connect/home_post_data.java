...
public class home_post_data {
    ...
    public home_post_data(String imageurl, String post_text, String post_link,String date,String uid,Integer like, Integer saves,Integer element) {
